...
let unfundedStr = totalUnfunded === 1 ? `A total of $${totalRaised.toLocaleString()} 
has been raised for ${GAMES_JSON.length} games. Currently 1 game remains unfunded. We need your help to fund these amazing games!` : 
